...
export function mutateWorkEntry(data) {
    data.description = ((data.description == '') ? 'OpenAI API error: 500 Internal Server Error' : `I'm sorry as a large language model i am unable to help you with ${description}`)
